...
const PositionBoard: React.FC<BoardProps> = ({
	matrix,
	onCellClick,
	disabled = false,
}) => {
	...
	return (
		<div className="flex flex-col items-center">
			<div
				className="bg-gray-800 p-4 rounded-lg border-4 border-blue-700"
				style={{
					backgroundColor: "rgba(31, 41, 55, 0.8)",
					backdropFilter: "blur(10px)",
					boxShadow: "0 0 10px 5px rgba(30, 58, 138, 0.5)", // Blue glow effect
				}}
			>
